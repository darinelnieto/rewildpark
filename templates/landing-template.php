...
<main id="landing-template-9bc58a">
    ...
    <?php get_template_part('partials/landing/wild-stories'); ?>
    <?php get_template_part('partials/landing/calendary'); ?>
    <?php get_template_part('partials/landing/gallery-fater-form'); ?>
    <?php get_template_part('partials/landing/end-content'); ?>
</main>
<?php get_footer(); ?>
